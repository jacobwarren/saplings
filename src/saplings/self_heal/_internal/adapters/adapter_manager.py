...
"""
Internal implementation of the adapter manager for Saplings.
...
from saplings.self_heal._internal.tuning import LoRaTrainer
...
class AdapterManager:
    ...
    def prune_adapters(self, min_success_rate: float = 0.5) -> None:
        ...
        logger.info(
            f"Pruned {len(adapters_to_remove)} adapters with success rate < {min_success_rate}"
        )
