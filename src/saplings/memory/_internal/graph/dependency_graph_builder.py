...
from saplings.memory._internal.graph.common import MemoryStoreProtocol
...
class DependencyGraphBuilder(ServiceBuilder[DependencyGraph]):
    ...
    def from_memory_store(self, memory_store: MemoryStoreProtocol) -> DependencyGraphBuilder:
        """
