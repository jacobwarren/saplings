...
"""
Planner service module for Saplings.

This module provides a service for planning functionality in the Saplings framework.
"""
...
class PlannerService(IPlannerService):
    ...
    def __init__(
        ...
        logger.info("PlannerService created (total_budget=%s)", config.total_budget)
    ...
    def _get_planner(self) -> Any:
        ...
        from saplings.core._internal.model_interface import ModelMetadata, ModelRole
    ...
    async def update_step_status(
        ...
        try:
            ...
            async def _update_step_status():
                ...
                # Convert string status to lowercase
