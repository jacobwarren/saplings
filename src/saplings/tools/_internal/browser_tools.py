...
from saplings._internal.tools.tool_registry import register_tool
...
def get_browser_manager():
    ...
    try:
        ...
        from saplings.api.di import get_container
