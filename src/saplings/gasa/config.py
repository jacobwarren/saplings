...
class GASAConfig(BaseModel):
    ...
    block_size: int = Field(512, description="Block size for block-diagonal packing")
    overlap: int = Field(64, description="Overlap between blocks for block-diagonal packing")
    ...
    cache_dir: Optional[str] = Field(None, description="Directory to cache masks")
    visualize: bool = Field(False, description="Whether to generate visualizations")
    visualization_dir: Optional[str] = Field(None, description="Directory to save visualizations")
