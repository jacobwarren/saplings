...
from saplings.gasa.core.token_mapper import TokenMapper
...
class BlockDiagonalPacker:
    ...
    def _map_tokens_to_chunks(
        ...
        Returns:
        -------
            List[ChunkInfo]: Information about document chunks
        ...
        for doc in documents:
            ...
            if hasattr(doc, "chunks") and doc.chunks:
                ...
                logger.warning(
                    f"Document {doc.id} has no chunks or create_chunks method. Treating content as single chunk."
                )
    ...
    def _find_related_chunks(
        ...
        for other_chunk in all_chunks:
            ...
            other_doc_id, other_chunk_id = other_chunk
