...
try:
    ...
    from saplings.gasa.packing.torch_block_packer import block_pack_torch, convert_to_torch
...
def get_block_diagonal_packer(use_torch: bool = True):
    ...
    if use_torch and HAS_TORCH:
        from saplings.gasa.packing.torch_block_packer import block_pack_torch
