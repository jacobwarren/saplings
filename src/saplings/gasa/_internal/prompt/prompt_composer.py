...
from saplings.security import sanitize_prompt

# Define protocols locally to avoid circular imports
...
class GASAPromptComposer:
    ...
    def compose_prompt(
        ...
        Args:
        ----
            documents: Documents to include in the prompt (implement Document protocol)
            prompt: User prompt
    ...
    def _sort_documents_by_graph_distance(self, documents: list[Any]) -> list[tuple[Any, int]]:
        """
        Sort documents by graph distance.

        Args:
        ----
            documents: Documents to sort (implement Document protocol)

        Returns:
        -------
            List[Tuple[Any, int]]: Sorted documents with distances
    ...
    def _group_documents_by_distance(
        self, sorted_docs: list[tuple[Any, int]]
        ...
        Returns:
        -------
            Tuple[List[Any], List[Any], List[Any]]: Core, near, and far documents
    ...
    def _create_summaries(self, far_docs: list[Any]) -> list[str]:
        """
        Create summaries for far documents.

        Args:
        ----
            far_docs: Far documents to summarize (implement Document protocol)
    ...
    def _build_composed_prompt(
        ...
        Args:
        ----
            core_docs: Core documents (implement Document protocol)
            near_docs: Near documents (implement Document protocol)
