...
# Use internal implementations directly since this is an internal service
from saplings.memory._internal import DependencyGraph, Document, DocumentMetadata, MemoryStore
from saplings.memory._internal.config import MemoryConfig
from saplings.memory._internal.indexer import get_indexer
...
class MemoryManager(IMemoryManager):
    ...
    def __init__(
        ...
        try:
            ...
            if memory_store is not None:
                ...
                validate_not_empty(memory_path, "memory_path")
        ...
        *,
        ...
        if hasattr(self.memory_store, "add_document") and hasattr(
            ...
            return await run_in_executor(
                lambda: self.memory_store.add_document(
    ...
    async def get_document(
        ...
        if hasattr(self.memory_store, "get_document"):
            # Run in executor to avoid blocking
            return await run_in_executor(
                lambda: self.memory_store.get_document(document_id), timeout=timeout
            )
