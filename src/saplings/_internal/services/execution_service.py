...
from saplings.executor.executor import Executor
...
class ExecutionService(IExecutionService):
    ...
    def __init__(
        self,
        model=None,  # Required for direct initialization
        ...
        if model is None:
            raise ValueError("Model must be provided to ExecutionService")
        ...
        # Initialize executor based on available dependencies
    ...
    def _initialize_executor(self, model) -> None:
        ...
        try:
            ...
            logger.info("Executor initialized with model")
        except Exception as e:
    ...
    async def execute(
        ...
        """
        # Import resilience utilities
        from saplings.core.resilience_patterns import with_timeout
        ...
        try:
            ...
            if validation_type_to_use:
                ...
                # Use the container to get the validator service
                try:
