...
def test_redact_slack_token() -> None:
    ...
    # Using a completely fake token pattern that won't trigger GitHub's secret scanning
    sample_text = "Slack bot token: xoxb-FAKE-TOKEN-FOR-TESTING-ONLY"
    redacted = redact(sample_text)
    assert "xoxb-FAKE-TOKEN-FOR-TESTING-ONLY" not in redacted
