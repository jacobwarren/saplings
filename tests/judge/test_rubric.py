...
class TestRubricLoader:
    ...
    def test_load_from_template_code(self):
        ...
        correctness_item = next(item for item in rubric.items if item.dimension == ScoringDimension.CORRECTNESS)
    ...
    def test_load_from_template_creative(self):
        ...
        creativity_item = next(item for item in rubric.items if item.dimension == ScoringDimension.CREATIVITY)
    ...
    def test_load_from_template_safety(self):
        ...
        safety_item = next(item for item in rubric.items if item.dimension == ScoringDimension.SAFETY)
