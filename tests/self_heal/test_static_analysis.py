...
class TestStaticAnalysis:
    ...
    def test_analyze_code_with_static_tools_ast_only(self, patch_generator):
        ...
        with patch("saplings.self_heal.patch_generator.PYLINT_AVAILABLE", False), patch(
            "saplings.self_heal.patch_generator.PYFLAKES_AVAILABLE", False
        ):
    ...
    def test_can_fix_with_static_analysis(self, patch_generator):
        ...
        static_analysis = {"ast": {"valid": True}, "pylint": [], "pyflakes": []}
    ...
    def test_fix_with_static_analysis_ast_errors(self, patch_generator):
        ...
        with patch.object(patch_generator, "_fix_missing_parenthesis", return_value=code + ")"):
            fixed_code = patch_generator._fix_with_static_analysis(
                code, static_analysis, error_info
            )
        ...
        code = "def foo()\n    print('Hello, world!')\n"
        static_analysis = {
            "ast": {"valid": False, "errors": [{"line": 1, "message": "invalid syntax"}]},
            "pylint": [],
            "pyflakes": [],
        }
        ...
        with patch.object(
            patch_generator,
            "_fix_invalid_syntax",
            return_value=code.replace("def foo()", "def foo():"),
        ):
            fixed_code = patch_generator._fix_with_static_analysis(
                code, static_analysis, error_info
            )
    ...
    def test_fix_with_static_analysis_pylint(self, patch_generator):
        ...
        static_analysis = {
            "ast": {"valid": True},
            "pylint": [
                {"line": 2, "symbol": "undefined-variable", "message": "Undefined variable 'bar'"}
            ],
            "pyflakes": [],
        }
        error_info = {}
        ...
        with patch.object(
            patch_generator,
            "_fix_undefined_variable",
            return_value=code.replace("print(bar)", "bar = None\n    print(bar)"),
        ):
            fixed_code = patch_generator._fix_with_static_analysis(
                code, static_analysis, error_info
            )
    ...
    def test_fix_with_static_analysis_pyflakes(self, patch_generator):
        ...
        static_analysis = {
            "ast": {"valid": True},
            "pylint": [],
            "pyflakes": [{"type": "flake", "message": "undefined name 'bar'", "line": 2}],
        }
        error_info = {}
        ...
        static_analysis = {
            "ast": {"valid": True},
            "pylint": [],
            "pyflakes": [{"type": "flake", "message": "'os' imported but unused", "line": 1}],
        }

        # Mock the _remove_import method
        with patch.object(
            patch_generator, "_remove_import", return_value=code.replace("import os\n\n", "")
        ):
            fixed_code = patch_generator._fix_with_static_analysis(
                code, static_analysis, error_info
            )
    ...
    def test_add_docstring(self, patch_generator):
        ...
        with patch.object(patch_generator, "_add_docstring") as mock_add_docstring:
            ...
            mock_add_docstring.return_value = (
                'def foo():\n    """Function docstring."""\n    print(\'Hello\')\n'
            )
    ...
    def test_end_to_end_static_analysis(self, patch_generator):
        ...
        with patch.object(
            patch_generator, "analyze_code_with_static_tools", return_value=mock_analysis
        ), patch.object(patch_generator, "_fix_with_static_analysis") as mock_fix, patch.object(
            patch_generator, "_can_fix_with_static_analysis", return_value=True
        ):
