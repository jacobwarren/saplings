...
class TestGraphExpander:
    ...
    def test_expand_with_subgraph(self):
        ...
        subgraph.find_paths.return_value = [
            [("doc1", "mentions", "entity:person:John"), ("entity:person:John", "mentioned_in", "doc3")]
        ]
        
        # Configure the graph data
        subgraph.graph = nx.DiGraph()
        subgraph.graph.add_edge("doc1", "entity:person:John", relationship_type="mentions", weight=0.9)
        subgraph.graph.add_edge("entity:person:John", "doc3", relationship_type="mentioned_in", weight=0.8)
